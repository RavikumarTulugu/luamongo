CC= g++
CFLAGS= -g -O2 -shared -fPIC -I /usr/include/lua5.1/ -I/usr/local/include/mongo/ -I/usr/include/mongo
AR= ar rcu
RANLIB= ranlib
RM= rm -f
LIBS=-lmongoclient -L/usr/local/lib -lboost_thread -lboost_system -lboost_filesystem 
OUTLIB=mongo.so
